...
filesize = "Filesize"
data = pd.read_csv("../../processed_data/most_memory_tools/tools_with_trinity/trinity/2.9.1.txt", sep=",",
                   names=["Tool_id", "Filesize", "Number_of_files", "Slots", "Memory_bytes", "Create_time"], usecols=["Filesize", "Memory_bytes"])
# Scale bytes to GB
